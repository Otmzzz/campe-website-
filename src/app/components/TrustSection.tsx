        ...
        <Reveal>
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              ...
              <h2 className="max-w-2xl text-4xl font-semibold leading-tight tracking-[-0.01em] text-[#07111f] sm:text-5xl lg:text-[3.05rem]">
        ...
        <Reveal delay={0.1}>
          <div className="mt-14 border-t border-slate-200">
            {domains.map((domain) => (
              ...
              >
                <h3 className="flex items-center gap-4 text-xl font-semibold leading-tight tracking-[-0.01em] text-[#07111f] sm:text-[1.35rem]">
                  <img
                    src={domain.icon}
                    alt=""
