...
export function Navbar({ onConsultationClick }: NavbarProps) {
  ...
  const megaMenuGroups: MegaMenuGroup[] = [
    ...
    },
    {
      label: 'About',
      href: '#about',
      description: 'Know the company, the founder, and the thinking behind CampE.',
      items: [
        {
          label: 'About CampE',
          href: '/about',
          description: 'Systems intelligence consulting for clearer visibility, control, and execution.',
        },
        {
          label: 'About the Founder',
          href: '/about/founder',
          description: 'A leadership journey shaped by operations, analytics, governance, and transformation.',
        },
        {
          label: 'Mission & Vision',
          href: '/about/mission-vision',
          description: 'CampE’s direction, purpose, and long-term commitment to measurable value.',
        },
        {
          label: 'Our Approach',
          href: '/about/approach',
          description: 'Practical systems thinking anchored on diagnosis, structure, execution, and control.',
        },
      ],
    },
    {
